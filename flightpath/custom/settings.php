...
$systemSettings["GRANT_FULL_ACCESS"] = TRUE;
////////////////////////////////////
...
$systemSettings["fileSystemPath"] = "/www/webservices/flightpath-dev";

////////////////////////////////////
// *** Database-related settings ***
////////////////////////////////////
$systemSettings["dbHost"] = "localhost"; // domain/ip address of the mysql host
$systemSettings["dbUser"] = "fpuser_dev"; 
$systemSettings["dbPass"] = "fpuserpass_dev"; 
$systemSettings["dbName"] = "dev_flightpath"; // Name of the actual database where
...
$systemSettings["extraTables"]["human_resources:students"] = array(
  "tableName" => "dev_flightpath_extra_data.students",
  "fields" => array(
...
$systemSettings["extraTables"]["human_resources:faculty_staff"] = array(
  "tableName" => "dev_flightpath_extra_data.faculty_staff",
  "fields" => array(
...
$systemSettings["extraTables"]["human_resources:advisor_student"] = array(
  "tableName" => "dev_flightpath_extra_data.advisor_student",
  "fields" => array(
    "facultyID" => "faculty_id",
    "studentID" => "student_id",    
  ),
...
$systemSettings["extraTables"]["course_resources:student_courses"] = array(
  "tableName" => "dev_flightpath_extra_data.student_courses",
  "fields" => array(
    "studentID" => "student_id",
...
$systemSettings["extraTables"]["course_resources:student_transfer_courses"] = array (
  "tableName" => "dev_flightpath_extra_data.student_transfer_courses",
  "fields" => array(
    "studentID" => "student_id",
...
$systemSettings["extraTables"]["course_resources:transfer_courses"] = array (
  "tableName" => "dev_flightpath_extra_data.transfer_courses",
  "fields" => array (
    "transferCourseID" => "transfer_course_id",
...
$systemSettings["extraTables"]["course_resources:transfer_institutions"] = array (
  "tableName" => "dev_flightpath_extra_data.transfer_institutions",
  "fields" => array (
    "institutionID" => "institution_id",
    "name" => "name",
    "state" => "state",
...
$systemSettings["extraTables"]["course_resources:transfer_eqv_per_student"] = array (
  "tableName" => "dev_flightpath_extra_data.transfer_eqv_per_student",
  "fields" => array (
    "studentID" => "student_id",
    "transferCourseID" => "transfer_course_id",
...
$systemSettings["extraTables"]["course_resources:subjects"] = array (
  "tableName" => "dev_flightpath_extra_data.subjects",
  "fields" => array (
    "subjectID" => "subject_id",
    "title" => "title",
  ),
...
$systemSettings["extraTables"]["course_resources:student_developmentals"] = array (
  "tableName" => "dev_flightpath_extra_data.student_developmentals",
  "fields" => array (
    "studentID" => "student_id",
...
$systemSettings["extraTables"]["flightpath_resources:student_tests"] = array (
  "tableName" => "dev_flightpath_extra_data.student_tests",
  "fields" => array (
    "studentID" => "student_id",
    "testID" => "test_id",
...
$systemSettings["extraTables"]["flightpath_resources:tests"] = array (
  "tableName" => "dev_flightpath_extra_data.tests",
  "fields" => array (
    "testID" => "test_id",
    "categoryID" => "category_id",
    "position" => "position",
